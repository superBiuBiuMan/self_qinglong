...
let login_token = 'NQVBQFJyQktGHlp6QkpbRl5LRl5qek4uXAQEBAAAAAB--T8Mc94OQuQcBNa5M5OYG5YuG-KFMu4dBFbcNtqdmCD9zmvChVx_0IvZlJcmbx1mXdWBbVYkYyqZqi5URO8kFEBbFLeUJyS4ztwQ7zTJVttxLZ_MjNUjAaVGG6mqvlLj1rNUTEznXAa3mQGs6eo5kzjV30eN48D4-QygvCNm9jS-CKqaIFpfSiDUIjVkEA4Ey05CF4kMSve9T3EpKiSI';
//需要修改的运动步数波动范围，脚本默认修改步数范围为1w9到2w5
const step = randomFriendPin($.getdata('xmMinStep')*1 || 13000, $.getdata('xmMaxStep')*1 || 15000);
function getToken() {
  if ($response.body) {
