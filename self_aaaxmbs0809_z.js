...
let login_token = 'NQVBQFJyQktGHlp6QkpbRl5LRl5qek4uXAQEBAAAAAPnTqfItd-zSNGoFGsYLss_eCXf1JjSDRHc2XWhepfw-JD4hLfNTPiQMHoCKidawcpC2RSnQ2OMMFl-pL9WXbn3pf8W-FM8-tvtzjHl7LysxpqDLEuswG_BEx8vpRZHXgsVHb4Y3hhfhz2YGAznQrbLtrjXnkZQnKfUt4mI5mHWbm7ViiLwRgC5py1YXXxLlTfXporrOXz1RL2FY8lSABFU';
//需要修改的运动步数波动范围，脚本默认修改步数范围为1w9到2w5
const step = randomFriendPin($.getdata('xmMinStep')*1 || 52541, $.getdata('xmMaxStep')*1 || 53521);
function getToken() {
  if ($response.body) {
